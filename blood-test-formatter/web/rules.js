...
const BloodTestRules = (function() {
    ...
    groups: [
      ...
      },
      {
        ...
        analyses: [
          ...
          { name: 'Protéinurie/Créatininurie', unit: 'g/mol', required: false, context: 'urine' },
          { name: 'Protéines/Créatinine', unit: 'g/mmol', required: false, context: 'urine', special: 'convert_mmol_to_mol' }
        ]
      }
    ]
  };
  ...
  /**
   * Cherche une analyse spécifique dans les données parsées
   */
  function applyRules(parsedData) {
    const dateGroups = {};
  ...
  // Exposer les fonctions et données publiques
  return {
    applyRules,
    unitMapping,
    nameMapping,
